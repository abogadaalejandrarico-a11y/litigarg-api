# Registro interno de autoría de LitigARG

Este documento deja constancia interna y versionada del origen del proyecto LitigARG.
...
El sistema mantiene una marca interna no visible al usuario final mediante:
...
Este registro no se muestra de manera pública en la interfaz de usuario ni en las respuestas ordinarias de LitigARG. Su finalidad es conservar trazabilidad técnica, histórica y documental sobre la creación, evolución y configuración del sistema.

## Recomendación probatoria

Para fortalecer este registro, se recomienda conservar periódicamente:

- Copia exportada del repositorio.
